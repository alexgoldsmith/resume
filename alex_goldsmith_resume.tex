...
\section{Skills}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Database Technologies}{SQL, SQLite, MySQL, SQL Server, MongoDB, Firestore, Relational and Document Models}
    \resumeSubItem{Other Technologies}{GCP, NodeJS, React, Svelte, Jest, Git, Docker, CMake, JSON, HTML, CSS, REST APIs, X12, LaTeX}
